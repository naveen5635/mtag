...
<html lang="zxx">
<head>
	<title>MTAG.Ind</title>
	<link rel="icon" type="image/x-icon" href="/mtag/mtag.ico">
	<meta charset="UTF-8">
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-7 m-auto text-white">
					<h2><tt>Home</tt></h2>
					<p><tt><b>STEP INTO A NEW WORLD OF FITNESS.	</b></tt></p>
				</div>
			</div>
		</div>
	</section>
	...
	<section class="pricing-section spad">
		<div class="container">
			<div class="section-title text-center">
				...
				<h2><tt>Pricing plans</tt></h2>
				<p><tt><b>Things work out best for those who make the best of how things work out!</b></tt></p>
			</div>
			<div class="row">
				        <?php 
